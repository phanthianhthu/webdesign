...
<!--datatable-->
  ...
  ?>
   ...
   <header id="header"><!--header-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 9651 151 054</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> thuptagcc19106@fpt.edu.vn</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/phanthi.anhthu.733/"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="header-middle" style="background-color:#FFC0CB"><!--header-middle-->
			<div class="container" >
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            <a href="index.php" style="background-color:#FFC0CB;color:#00FFF">Haha Shop
                            <img src="images/logo.jpg" width="70" height="70"></a>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav" >                               
                                ...
                                ?> 
                                     <li><a style="background-color:#FFF" href="?page=update_customer">
                                     <i class="fa fa-lock"></i>Hi, <?php echo $_SESSION['us']?></a>
                                     </li>
                                     <li><a href="?page=logout" style="background-color:#FFC0CB;color:#00FFF">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <li><a href="?page=login" style="background-color:#FFC0CB;color:#00FFF">
                                <i class="fa fa-lock"></i>Login</a></li>
                                <li><a href="Register.php" style="background-color:#FFC0CB;color:#00FFF">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Management<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="category_management.php">Category</a></li>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Ha<span>ha</span></h2>
                        <p>Haha is one of the largest online fashion retailers in the world offering the latest in fashion style and leading the trend.<br>
                          We strive to innovate, excite, and provide our customers with a range of the hottest looks at the hottest prices. </p>
                        <div class="footer-social">
                            <a href="https://www.facebook.com/phanthi.anhthu.733/" target="_blank"><i class="fa fa-facebook"></i></a>
